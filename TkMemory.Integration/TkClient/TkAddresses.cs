    ...
    internal static class TkAddresses {
        ...
        public static class Environment {
            ...
            public static class Map {
                ...
                public static readonly Address Name = new Address("NexusTK.exe", 0x0029B4A4, new[] { 0xF8 });
        ...
        public static class Group {
            ...
            public static readonly Address Name = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0x21C });
            //public static readonly Address Size = new Address(0x6DD490, new[] { 0x3CB0 });
            public static readonly Address Size = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0x3CB0 });
            //public static readonly Address Uid = new Address(0x6DD490, new[] { 0x218 });
            public static readonly Address Uid = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0x218 });
            ...
            public static class Vita {
                ...
                public static readonly Address Current = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0x338 });
                //public static readonly Address Max = new Address(0x6DD490, new[] { 0x334 });
                public static readonly Address Max = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0x334 });
            }
        }
        ...
        public static class Entity {
            ...
            public static readonly Address Count = new Address("NexusTK.exe", 0x0027A754, new[] { 0x424, 0x38, 0xC });
            //public static readonly Address Direction = new Address(0x6FE61C, new[] { 0x1C9 });
            public static readonly Address Direction = new Address("NexusTK.exe", 0x0029BF2C, new[] { 0x1C9 });
            //public static readonly Address Name = new Address(0x6FE61C, new[] { 0x12E });
            public static readonly Address Name = new Address("NexusTK.exe", 0x0029BF2C, new[] { 0x12E });
            //public static readonly Address Uid = new Address(0x6FE61C, new[] { 0x100 });
            public static readonly Address Uid = new Address("NexusTK.exe", 0x0029BF2C, new[] { 0x100 });

            public static class Coordinates {
                //public static readonly Address X = new Address(0x6FE61C, new[] { 0x104 });
                public static readonly Address X = new Address("NexusTK.exe", 0x0029BF2C, new[] { 0x104 });
                //public static readonly Address Y = new Address(0x6FE61C, new[] { 0x108 });
                public static readonly Address Y = new Address("NexusTK.exe", 0x0029BF2C, new[] { 0x108 });
            }

            public static class Pixels {
                //public static readonly Address X = new Address(0x6FE61C, new[] { 0x10C });
                public static readonly Address X = new Address("NexusTK.exe", 0x0029BF2C, new[] { 0x10C });
                //public static readonly Address Y = new Address(0x6FE61C, new[] { 0x110 });
                public static readonly Address Y = new Address("NexusTK.exe", 0x0029BF2C, new[] { 0x110 });
            }
        }
        ...
        public static class Self {
            ...
            public static readonly Address Gold = new Address("NexusTK.exe", 0x0029B4D4, new[] { 0x11C });
            ...
            public static readonly Address Uid = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0xFC });

            public static class Inventory {
                public const int PositionOffset = 0x1FC;

                //public static readonly Address DisplayName = new Address(0x6DD490, new[] { 0x16410A });
                public static readonly Address DisplayName = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0x16410A });
                //public static readonly Address ItemName = new Address(0x6DD490, new[] { 0x1641AA });
                public static readonly Address ItemName = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0x1641AA });
                //public static readonly Address Quantity = new Address(0x6DD490, new[] { 0x1642EC });
                public static readonly Address Quantity = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0x1642EC });
            }

            public static class Mana {
                //public static readonly Address Current = new Address(0x6FE238, new[] { 0x10C });
                public static readonly Address Current = new Address("NexusTK.exe", 0x0029B4D4, new[] { 0x10C });
                //public static readonly Address Max = new Address(0x6FE238, new[] { 0x110 });
                public static readonly Address Max = new Address("NexusTK.exe", 0x0029B4D4, new[] { 0x110 });
            }
            ...
            public static class Spells {
                ...
                public static readonly Address DisplayName = new Address("NexusTK.exe", 0x0029ADFC, new[] { 0x16A83C });
            }
            ...
            public static class Vita {
                ...
                public static readonly Address Current = new Address("NexusTK.exe", 0x0029B4D4, new[] { 0x104 });
